...
#region GAMEPAD UPDATES BY STEP
...
for (var _i = 0; _i < _gp_num; _i++;){
	...
	if gamepad_is_connected(_i) {
		...
		global.joy_stickl_padl_pressed[_i] = false;
			if ( joy_stickl_padl_pressed_flag == false && global.joy_stickl_padl[_i] == true ){
				global.joy_stickl_padl_pressed[_i] = true;
				joy_stickl_padl_pressed_flag = true;
			}
			if ( joy_stickl_padl_pressed_flag == true && global.joy_stickl_padl[_i] == false ){
				global.joy_stickl_padl_pressed[_i] = false;
				joy_stickl_padl_pressed_flag = false;
			}
			
		global.joy_stickl_padl_released[_i] = false;
			if ( joy_stickl_padl_released_flag == false && global.joy_stickl_padl[_i] == false ){
				global.joy_stickl_padl_released[_i] = true;
				joy_stickl_padl_released_flag = true;
			}
			if ( joy_stickl_padl_released_flag == true && global.joy_stickl_padl[_i] == true ){
				global.joy_stickl_padl_released[_i] = false;
		...
		global.joy_stickl_padr_pressed[_i] = false;
			if ( joy_stickl_padr_pressed_flag == false && global.joy_stickl_padr[_i] == true ){
				global.joy_stickl_padr_pressed[_i] = true;
				joy_stickl_padr_pressed_flag = true;
			}
			if ( joy_stickl_padr_pressed_flag == true && global.joy_stickl_padr[_i] == false ){
				global.joy_stickl_padr_pressed[_i] = false;
				joy_stickl_padr_pressed_flag = false;
			}
			
		global.joy_stickl_padr_released[_i] = false;
			if ( joy_stickl_padr_released_flag == false && global.joy_stickl_padr[_i] == false ){
				global.joy_stickl_padr_released[_i] = true;
				joy_stickl_padr_released_flag = true;
			}
			if ( joy_stickl_padr_released_flag == true && global.joy_stickl_padr[_i] == true ){
				global.joy_stickl_padr_released[_i] = false;
		...
		global.joy_stickl_padu_pressed[_i] = false;
			if ( joy_stickl_padu_pressed_flag == false && global.joy_stickl_padu[_i] == true ){
				global.joy_stickl_padu_pressed[_i] = true;
				joy_stickl_padu_pressed_flag = true;
			}
			if ( joy_stickl_padu_pressed_flag == true && global.joy_stickl_padu[_i] == false ){
				global.joy_stickl_padu_pressed[_i] = false;
				joy_stickl_padu_pressed_flag = false;
			}
			
		global.joy_stickl_padu_released[_i] = false;
			if ( joy_stickl_padu_released_flag == false && global.joy_stickl_padu[_i] == false ){
				global.joy_stickl_padu_released[_i] = true;
				joy_stickl_padu_released_flag = true;
			}
			if ( joy_stickl_padu_released_flag == true && global.joy_stickl_padu[_i] == true ){
				global.joy_stickl_padu_released[_i] = false;
		...
		global.joy_stickl_padd_pressed[_i] = false;
			if ( joy_stickl_padd_pressed_flag == false && global.joy_stickl_padd[_i] == true ){
				global.joy_stickl_padd_pressed[_i] = true;
				joy_stickl_padd_pressed_flag = true;
			}
			if ( joy_stickl_padd_pressed_flag == true && global.joy_stickl_padd[_i] == false ){
				global.joy_stickl_padd_pressed[_i] = false;
				joy_stickl_padd_pressed_flag = false;
			}
			
		global.joy_stickl_padd_released[_i] = false;
			if ( joy_stickl_padd_released_flag == false && global.joy_stickl_padd[_i] == false ){
				global.joy_stickl_padd_released[_i] = true;
				joy_stickl_padd_released_flag = true;
			}
			if ( joy_stickl_padd_released_flag == true && global.joy_stickl_padd[_i] == true ){
				global.joy_stickl_padd_released[_i] = false;
		...
		global.joy_stickr_padl_pressed[_i] = false;
			if ( joy_stickr_padl_pressed_flag == false && global.joy_stickr_padl[_i] == true ){
				global.joy_stickr_padl_pressed[_i] = true;
				joy_stickr_padl_pressed_flag = true;
			}
			if ( joy_stickr_padl_pressed_flag == true && global.joy_stickr_padl[_i] == false ){
				global.joy_stickr_padl_pressed[_i] = false;
				joy_stickr_padl_pressed_flag = false;
			}
			
		global.joy_stickr_padl_released[_i] = false;
			if ( joy_stickr_padl_released_flag == false && global.joy_stickr_padl[_i] == false ){
				global.joy_stickr_padl_released[_i] = true;
				joy_stickr_padl_released_flag = true;
			}
			if ( joy_stickr_padl_released_flag == true && global.joy_stickr_padl[_i] == true ){
				global.joy_stickr_padl_released[_i] = false;
		...
		global.joy_stickr_padr_pressed[_i] = false;
			if ( joy_stickr_padr_pressed_flag == false && global.joy_stickr_padr[_i] == true ){
				global.joy_stickr_padr_pressed[_i] = true;
				joy_stickr_padr_pressed_flag = true;
			}
			if ( joy_stickr_padr_pressed_flag == true && global.joy_stickr_padr[_i] == false ){
				global.joy_stickr_padr_pressed[_i] = false;
				joy_stickr_padr_pressed_flag = false;
			}
			
		global.joy_stickr_padr_released[_i] = false;
			if ( joy_stickr_padr_released_flag == false && global.joy_stickr_padr[_i] == false ){
				global.joy_stickr_padr_released[_i] = true;
				joy_stickr_padr_released_flag = true;
			}
			if ( joy_stickr_padr_released_flag == true && global.joy_stickr_padr[_i] == true ){
				global.joy_stickr_padr_released[_i] = false;
		...
		global.joy_stickr_padu_pressed[_i] = false;
			if ( joy_stickr_padu_pressed_flag == false && global.joy_stickr_padu[_i] == true ){
				global.joy_stickr_padu_pressed[_i] = true;
				joy_stickr_padu_pressed_flag = true;
			}
			if ( joy_stickr_padu_pressed_flag == true && global.joy_stickr_padu[_i] == false ){
				global.joy_stickr_padu_pressed[_i] = false;
				joy_stickr_padu_pressed_flag = false;
			}
			
		global.joy_stickr_padu_released[_i] = false;
			if ( joy_stickr_padu_released_flag == false && global.joy_stickr_padu[_i] == false ){
				global.joy_stickr_padu_released[_i] = true;
				joy_stickr_padu_released_flag = true;
			}
			if ( joy_stickr_padu_released_flag == true && global.joy_stickr_padu[_i] == true ){
				global.joy_stickr_padu_released[_i] = false;
		...
		global.joy_stickr_padd_pressed[_i] = false;
			if ( joy_stickr_padd_pressed_flag == false && global.joy_stickr_padd[_i] == true ){
				global.joy_stickr_padd_pressed[_i] = true;
				joy_stickr_padd_pressed_flag = true;
			}
			if ( joy_stickr_padd_pressed_flag == true && global.joy_stickr_padd[_i] == false ){
				global.joy_stickr_padd_pressed[_i] = false;
				joy_stickr_padd_pressed_flag = false;
			}
			
		global.joy_stickr_padd_released[_i] = false;
			if ( joy_stickr_padd_released_flag == false && global.joy_stickr_padd[_i] == false ){
				global.joy_stickr_padd_released[_i] = true;
				joy_stickr_padd_released_flag = true;
			}
			if ( joy_stickr_padd_released_flag == true && global.joy_stickr_padd[_i] == true ){
				global.joy_stickr_padd_released[_i] = false;
